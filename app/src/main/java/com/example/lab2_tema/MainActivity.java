...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickBtn1(View view){
        ...
        if(nb1.trim().equals("")) {
            Toast.makeText(MainActivity.this, "introdu primul numar", Toast.LENGTH_SHORT).show();
            return;
        }

        if(nb2.trim().equals("")) {
            Toast.makeText(MainActivity.this, "introdu al doilea numar", Toast.LENGTH_SHORT).show();
            return;
        }
