...
public class MainActivity2 extends AppCompatActivity {
  ...
  int dif;
    ...
    public void onClickBtn2(View view) {
        Toast.makeText(MainActivity2.this, "Ai ales operatia matematica de adunare ", Toast.LENGTH_SHORT).show();
    ...
    public void onClickBtn3(View view) {
        ...
        Toast.makeText(MainActivity2.this, "Ai ales operatia matematica de scadere ", Toast.LENGTH_SHORT).show();
